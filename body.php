				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=78"><div class="shop">
							...
							<div class="shop-body">
								<h3>Весення<br>Коллекция</h3>
								<a href="product.php?p=78" class="cta-btn">Покупка<i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div></a>
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=72"><div class="shop">
							...
							<div class="shop-body">
								...
								<a href="product.php?p=72" class="cta-btn">Покупка<i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div></a>
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=79"><div class="shop">
							...
							<div class="shop-body">
								<h3>Коллекция<br>рубашек</h3>
								<a href="product.php?p=79" class="cta-btn">Покупка<i class="fa fa-arrow-circle-right"></i></a>
							</div>
                            </div></a>
					</div>
					<!-- /shop -->
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">Весення Коллекция</a></li>
									<li><a data-toggle="tab" href="#tab1">Худи</a></li>
									<li><a data-toggle="tab" href="#tab1">Рубашки</a></li>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab2">Головные уборы</a></li>
									<li><a data-toggle="tab" href="#tab2">Футболки</a></li>
									<li><a data-toggle="tab" href="#tab2">Рубашки</a></li>
									<li><a data-toggle="tab" href="#tab2">Штаны</a></li>
								</ul>
							</div>
						</div>
					</div>
							...
							<div id="get_product_home2">
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h4 class="product-price">3000 рублей <del class="product-old-price">3300 рублей</del></h4>
									</div>
								</div>
								<!-- /product widget -->
